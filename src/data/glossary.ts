...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  entry("my-number-card", "マイナンバーカード", "本人確認などに使うカード", "氏名や住所などを確認したり、オンラインで手続きしたりするときに使うカードです。"),
  entry("signing-certificate", "署名用電子証明書", "オンラインで本人を確かめるための証明", "マイナンバーカードに入っている、オンラインで本人確認や電子署名をするときに使う証明です。"),
  entry("electronic-signature", "電子署名", "オンラインで本人が手続きしたと示す操作", "マイナンバーカードなどを使い、本人が手続きをしたことを確認するための操作です。"),
  entry("signing-pin", "署名用電子証明書の暗証番号", "電子署名で使う番号", "電子署名のときに使う6〜16桁の英数字の番号です。4桁の暗証番号とは別の番号です。"),
  entry("user-registration", "利用者登録", "サービスを使うための事前登録", "オンラインのサービスを使い始める前に、連絡先などを登録して利用できるようにする手続きです。"),
  entry("online-application", "電子申請", "インターネットで行う申請", "窓口や郵送ではなく、スマートフォンやパソコンを使ってインターネットで行う申請です。"),
  entry("mail-request", "郵送請求", "郵便で書類を送って行う手続き", "必要な書類を郵便で送り、窓口へ行かずに証明書などを請求する方法です。"),
  entry("convenience-store-issue", "コンビニ交付", "コンビニで証明書を受け取る方法", "対応するコンビニの機械を使って、証明書を受け取る方法です。"),
